...
<th style="font-weight:bold"> Monday</th>
            <td>   <?php echo $monday_phase1; ?> </td>
            <td>   <?php echo $monday_phase2; ?> </td>
            <td>   <?php echo $monday_phase3; ?> </td>
            <td>   <?php echo $monday_phase4; ?> </td>
            <td>   <?php echo $monday_phase5; ?> </td>
            <td>   <?php echo $monday_phase6; ?> </td>
            <td>   <?php echo $monday_phase7; ?> </td>
            <td>   <?php echo $monday_phase8; ?> </td>
            <td>   </td>
        </tr>
...
<th style="font-weight:bold"> Tuesday</th>
            <td>  <?php echo $tuesday_phase1; ?> </td>
            <td>  <?php echo $tuesday_phase2; ?> </td>
            <td>  <?php echo $tuesday_phase3; ?> </td>
            <td>  <?php echo $tuesday_phase4; ?> </td>
            <td>  <?php echo $tuesday_phase5; ?> </td>
            <td>  <?php echo $tuesday_phase6; ?> </td>
            <td>  <?php echo $tuesday_phase7; ?> </td>
            <td>  <?php echo $tuesday_phase8; ?> </td>
            <td>   </td>
        </tr>
...
<th style="font-weight:bold"> Wednesday</th>
            <td>  <?php echo $wednesday_phase1; ?></td>
            <td>  <?php echo $wednesday_phase2; ?></td>
            <td>  <?php echo $wednesday_phase3; ?></td>
            <td>  <?php echo $wednesday_phase4; ?></td>
            <td>  <?php echo $wednesday_phase5; ?></td>
            <td>  <?php echo $wednesday_phase6; ?></td>
            <td>  <?php echo $wednesday_phase7; ?></td>
            <td>  <?php echo $wednesday_phase8; ?></td>
            <td>  </td>
        </tr>
...
<th style="font-weight:bold"> Thursday</th>
            <td> <?php echo $thursday_phase1; ?> </td>
            <td> <?php echo $thursday_phase2; ?> </td>
            <td> <?php echo $thursday_phase3; ?> </td>
            <td> <?php echo $thursday_phase4; ?> </td>
            <td> <?php echo $thursday_phase5; ?> </td>
            <td> <?php echo $thursday_phase6; ?> </td>
            <td> <?php echo $thursday_phase7; ?> </td>
            <td> <?php echo $thursday_phase8; ?> </td>
            <td>  </td>
        </tr>
...
<th style="font-weight:bold"> Friday</th>
            <td>   <?php echo $friday_phase1; ?> </td>
            <td>   <?php echo $friday_phase2; ?> </td>
            <td>   <?php echo $friday_phase3; ?> </td>
            <td>   <?php echo $friday_phase4; ?> </td>
            <td>   <?php echo $friday_phase5; ?> </td>
            <td>   <?php echo $friday_phase6; ?> </td>
            <td>   <?php echo $friday_phase7; ?> </td>
            <td>   <?php echo $friday_phase8; ?> </td>
            <td>   </td>
        </tr>
...
<th style="font-weight:bold"> Saturday</th>
            <td> <?php echo $saturday_phase1; ?> </td>
            <td> <?php echo $saturday_phase2; ?> </td>
            <td> <?php echo $saturday_phase3; ?> </td>
            <td> <?php echo $saturday_phase4; ?> </td>
            <td> <?php echo $saturday_phase5; ?> </td>
            <td> <?php echo $saturday_phase6; ?> </td>
            <td> <?php echo $saturday_phase7; ?> </td>
            <td> <?php echo $saturday_phase8; ?> </td>
            <td> <?php  ?> </td>
        </tr>

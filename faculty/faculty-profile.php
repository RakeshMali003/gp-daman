...
if(isset($_POST['submit'])){
  ...
  $jdate = $_POST['jdate'];
  $email = $_POST['access_id'];
  $password = $_POST['password'];

 

  $updatequery =  "UPDATE `add_teacher` SET `fname`='$fname',`lname`='$lname' WHERE email = $email";
        ...
        <form class="row g-3 mt-2" method="POST">
           <h4>Personal Details</h4><hr>
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="validationDefault05" value="<?php echo $result['fname']; ?>" name="fname" pattern="[A-Za-z ]+" required>
            </div>

            <div class="col-md-4">
              <label for="validationDefault05" class="form-label">Last name</label>
              <input type="text" class="form-control" id="validationDefault05" value="<?php echo $result['lname']; ?>" name="lname" pattern="[A-Za-z ]+" required>
            </div>

            <div class="col-md-4">
              <label for="validationDefault05" class="form-label">Middle name</label>
              <input type="text" class="form-control" id="validationDefault05" value="<?php echo $result['mname']; ?>" name="mname" pattern="[A-Za-z ]+" required>
            </div>
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="validationDefault05" value="<?php echo $result['mobile']; ?>" name="Mobile" minlength="10" maxlength="12" required>
            </div>

            <div class="col-md-4">
              <label for="validationDefault05" class="form-label">Alternate Mobile Number</label>
              <input type="text" class="form-control" id="validationDefault05" value="<?php echo $result['amobile']; ?>" name="Amobile" minlength="10" maxlength="12" required>
            </div>
      ...
      <select class="form-select" id="validationDefault04" name="gender" required>
        ...
        <option value="other">Other</option>
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="validationDefault05" value="<?php echo $result['pincode']; ?>" name="pincode" required>
            </div>
